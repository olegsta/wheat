set :application, 'wheat'
set :repo_url, 'git@github.com:storuky/wheat.git'
# set :rvm_type, :user
...
set :linked_files, %w{config/database.yml config/thinking_sphinx.yml config/production.sphinx.conf}
